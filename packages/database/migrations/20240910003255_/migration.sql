...
-- AddForeignKey
ALTER TABLE "liked" ADD CONSTRAINT "liked_gif_id_fkey" FOREIGN KEY ("gif_id") REFERENCES "gif"("gif_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "comment" ADD CONSTRAINT "comment_gif_id_fkey" FOREIGN KEY ("gif_id") REFERENCES "gif"("gif_id") ON DELETE CASCADE ON UPDATE CASCADE;
